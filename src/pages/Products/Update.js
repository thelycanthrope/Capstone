...
import { Prompt, useLocation, withRouter } from 'react-router-dom';
...
const onSubmit = (values) =>{
    ...
    toast.success("Congratualtions! Product has been updated successfully",{position:toast.POSITION.TOP_RIGHT})
    history.push('/home')
...
function Update(props) {
    ...
    let pname = location.state.state.pname
    let description = location.state.state.description
    let manufacturer = location.state.state.manufacturer
    let price = location.state.state.price
    let quantity = location.state.state.quantity
    let url = location.state.state.url
    let category=location.state.state.category
        pathname=location.state.pathname
        path="http://localhost:5500" + pathname
        ...
        <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit}  >
            ...
            <div className="row">
                <div className="col-sm">
                    <label htmlFor="pname" className="form-label text-white d-flex justify-content-center">Product Name</label> <span style={{color:"red"}}><ErrorMessage name="pname"/></span>
                ...
                <div className="col-sm">
                    ...
                    <div className="input-group mb-3">
                        <Field type="text" className="form-control text-white bg-dark" id="manufacturer" name="manufacturer" aria-describedby="basic-addon3"  textalign="center"/>
                    </div>
                </div>
                </div>
